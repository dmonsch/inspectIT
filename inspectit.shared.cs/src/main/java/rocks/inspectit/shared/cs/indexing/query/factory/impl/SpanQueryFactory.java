...
public class SpanQueryFactory<E extends IIndexQuery> extends AbstractQueryFactory<E> {
	 ...
	 */
	private static final List<Class<?>> CLASSES_LIST = Collections.unmodifiableList(Arrays.<Class<?>> asList(MobileSpan.class, EUMSpan.class, ServerSpan.class, ClientSpan.class));
