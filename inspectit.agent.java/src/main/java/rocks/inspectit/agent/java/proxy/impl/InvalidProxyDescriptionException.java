...
public class InvalidProxyDescriptionException extends Exception {
	...
	/**
	 * Utiltiy method for easy exception throwing. The given format String is used to print the
	 * exception message. However, this method performs some uility modifications when printing:
	 * <br>
	 * a) Class<?> instances will be printed using their canonical names <br>
	 * b) Class<?> arrays will be printed in the form (class1, class2, ...) using their canonical
	 * names
	 *
	 * @param formatMsg
	 *            the format message
	 * @param args
	 *            the arguemnts for the format message
	...
	public static void throwException(String formatMsg, Object... args) throws InvalidProxyDescriptionException {
		...
		throw new InvalidProxyDescriptionException(String.format(formatMsg, args));
	}
