...
public class AutoboxingHelper {
	...
	/**
	 * Returns the class object for normal types.
	 * Return the primitive type for int,long,etc (the Integer.TYPE and so on)
	 * @param name
	 * @param initialize
	 * @param classloader
	...
	/**
	 * Returns true if the name equals the name of the primtive "void" return type (NOT THE Void.class)"
	 * @param name
	 * @return
	 */
