...
public class HTMLScriptInjector {
	...
	private enum Status {
		/**
		 * Initialisation status, the parser has not started or has not found anythin it can base
		 * its decision on.
		 */
		INIT,
		/**
		 * Status saying that the document is non-html. No Injection wil lbe performed, the parser
		 * has terminated.
		 */
		UNPARESABLE,
